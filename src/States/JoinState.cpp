...
void JoinState::HandleCommand(const Command& command) {
    printf_debug("Entered [JoinState], handling command");
    ...
    case CommandType::JOIN:
        ...
        Error("Cannot change channel, still waiting for server response.");
        break;
...
void JoinState::HandleMessage(const Message& message) {
    printf_debug("Entered [JoinState], handling message");
